...
1. Send POST to http://localhost:3000/auth/login with Content-Type: application/json
```json
{ "client_id": "webapp",
  ...
  "password": "test123!@#" }
```
2. Copy Server response
```json
{ "code": "eyJhbGciInR5cCI6IkpXVCJ9.eyJjbGlzZXJJ...." }
```
3. Send POST to http://localhost:3000/auth/token with Content-Type: application/json
```json
{ "code": "eyJhbGciInR5cCI6IkpXVCJ9.eyJjbGlzZXJJ....",
  "clientId": "webapp",
  "username": "super_admin"}
...
{ "accessToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVC....",
  "refreshToken": "9af7cec11c93335637bb60060515d0a3d5364294...." }
```
#### Trouble-Shoot
* if redis doesn't save the code
